<nav class="page-sidebar" id="sidebar">
    <div id="sidebar-collapse">
        <div class="admin-block d-flex">
            <div>
                <img src="{{ url('/') }}/admin/img/admin-avatar.png" width="45px" />
            </div>
        ...
        <ul class="side-menu metismenu">
            ...
            <li>
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{ route('add-aboutus-content') }}">Add About us</a>
                    </li>
                    <li>
                        <a href="{{ route('view-aboutus-content') }}">View About us</a>
                    </li>
                    <li>
                        <a href="panels.html">Add Core values</a>
                    </li>
                    <li>
                        <a href="buttons.html">View Core values</a>
                    </li>                    
                </ul>
            </li>
            <li>
